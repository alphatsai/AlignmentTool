...
using namespace std;
void AlignResi(){
	TFile* merge_i11 = new TFile("/afs/cern.ch/work/j/jtsai/ESAlignment/CMSSW_7_0_7_dev/src/AlignmentTool/ESAlignTool/test/OnLxplus/02Oct_PoinGun1M_GTv6/job_SinglePionGun_GEN_SIM_v1__tdoan-job_SinglePionGun_RECO_v1-a2645d794d4263c6295ef839881df757__USER.root");	
	...
	drawResidual(merge_i11,"png/MisAlignmentResidual_GTv6.png");
