...
## 3. 2016 RunB, 80X_dataRun2_Prompt_v8 (used Run2015 Boff)
...
## 4. 2016 RunB, 80X_dataRun2_Prompt_v8_CustomTrackerAndECAL_2016B_v0 (used Run2015 Boff)
X0={'mR':-0.303001, 'mF':-0.284,   'pF':0.324,   'pR':0.357001}
Y0={'mR':-0.462001, 'mF':-0.477,   'pF':-0.932,  'pR':-0.905  }
Z0={'mR':-308.922,  'mF':-304.289, 'pF':304.167, 'pR':308.77  }
A0={'mR':1.4,       'mF':1.4,      'pF':-1.3,    'pR':-1.7    }
B0={'mR':0.5,       'mF':0.8,      'pF':0.1,     'pR':0.4     }
G0={'mR':0.0,       'mF':0.6,      'pF':0.8,     'pR':0.6     }

### Input/Output files
inputFile='results/24May_Run2016B/inputMatrixElements_cfi.txt'
output='results/24May_Run2016B/pdf/Stabilities'
